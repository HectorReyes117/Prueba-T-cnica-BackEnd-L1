...
using PruebaTecnicaBackend.Infraestructure.Repositories;
using System.Text;
...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Prueba Tecnica Backend-L1", Version = "v1" });
...
builder.Services.AddDbContext<PruebaTecnicaBackendContext>(options =>
{
